...
/// Composant de filtre "Prix" pour les restaurants.
/// Affiche une série de chips représentant les niveaux de prix.
/// Sélection multiple possible.
///
/// - [selected] : ensemble des clés de prix actuellement sélectionnées.
/// - [onToggle] : callback appelé lors de la sélection ou désélection d'une clé.
class PrixFilter extends StatelessWidget {
  /// Ensemble des clés Firestore sélectionnées (ex. '€', '€€').
  final Set<String> selected;

  /// Fonction appelée lors du basculement d'un filtre.
  /// - [key]     : clé Firestore du prix.
